...
public class ApplicationUrlsTest {
  ...
  private static final String INTENTIONALLY_SPLIT_UP_TO_AVOID_REFACTORING_HEALTH_CHECKS_PAGE = "/he" +"a" + "lth";
  ...
  @Table({@Row({READY_PAGE, INTENTIONALLY_SPLIT_UP_TO_AVOID_REFACTORING_READY_PAGE}),
          ...
          @Row({HEALTH_CHECKS_PAGE, INTENTIONALLY_SPLIT_UP_TO_AVOID_REFACTORING_HEALTH_CHECKS_PAGE})
  })
  @Test
